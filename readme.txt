...
- Color the output green if it is passed the validation and red if it didn’t.
- Return exit code 0 if it is passed the validation and exit code 1 if it didn’t.
